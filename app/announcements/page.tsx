...
export default function AnnouncementsPage() {
  ...
  const announcementItems = [
    ...
    { title: "【国际教育】国际学院学生团队在第十四届挑战杯竞赛中斩获佳绩", date: "2024.11.11" },
    { title: "【国际教育】国际学院学生团队在第十四届挑战杯竞赛中斩获佳绩", date: "2024.11.11" },
    { title: "【通知公告】关于2024年秋季学期期末考试安排的通知", date: "2024.11.08" },
    { title: "【招生公告】2025年春季学期交换生项目申请通知", date: "2024.11.05" },
    { title: "【学术公告】国际学院2024年度学术报告会安排", date: "2024.11.02" },
    { title: "【管理通知】关于加强学生宿舍管理的通知", date: "2024.10.30" },
    { title: "【奖学金公示】2024年度优秀学生奖学金获奖名单公示", date: "2024.10.28" },
    { title: "【考试通知】关于2024年下半年英语等级考试报名的通知", date: "2024.10.25" },
    { title: "【活动公告】国际学院文化节活动方案公布", date: "2024.10.22" },
    { title: "【就业通知】2025届毕业生就业推荐表填写说明", date: "2024.10.20" },
    { title: "【学籍管理】关于学生学籍信息核查的通知", date: "2024.10.18" },
    { title: "【安全提醒】校园安全防范温馨提示", date: "2024.10.15" },
  ]

  const totalPages = Math.ceil(announcementItems.length / itemsPerPage)
  const startIndex = (currentPage - 1) * itemsPerPage
  const currentItems = announcementItems.slice(startIndex, startIndex + itemsPerPage)
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span className="text-teal-600">通知公示</span>
          </div>
        </div>
      </div>
          ...
          <main className="flex-1">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="bg-teal-500 text-white px-6 py-4 rounded-t-lg flex items-center gap-3">
                ...
                <h1 className="text-xl font-semibold">通知公示</h1>
              </div>
