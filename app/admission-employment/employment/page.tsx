...
export default function EmploymentPage() {
  ...
  const employmentData = [
    { title: "【就业指导】2025届毕业生就业指导讲座安排", date: "2025.08.20" },
    { title: "【就业指导】国际学院毕业生就业质量报告", date: "2025.08.18" },
    { title: "【就业指导】海外就业机会及申请指南", date: "2025.08.15" },
    { title: "【就业指导】校园招聘会企业信息汇总", date: "2025.08.12" },
    { title: "【就业指导】简历制作与面试技巧培训", date: "2025.08.10" },
    { title: "【就业指导】国际学院优秀毕业生就业案例分享", date: "2025.08.08" },
    { title: "【就业指导】跨国企业实习机会推荐", date: "2025.08.05" },
    { title: "【就业指导】职业规划与发展路径指导", date: "2025.08.03" },
    { title: "【就业指导】毕业生就业创业政策解读", date: "2025.08.01" },
    { title: "【就业指导】国际学院就业服务中心联系方式", date: "2025.07.28" },
    { title: "【就业指导】海外深造申请流程及要求", date: "2025.07.25" },
  ]

  const totalPages = Math.ceil(employmentData.length / itemsPerPage)
  const startIndex = (currentPage - 1) * itemsPerPage
  const currentItems = employmentData.slice(startIndex, startIndex + itemsPerPage)
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-600">
                    展示第{startIndex + 1}-{Math.min(startIndex + itemsPerPage, employmentData.length)}条信息，共计
                    {employmentData.length}条信息
                  </div>
