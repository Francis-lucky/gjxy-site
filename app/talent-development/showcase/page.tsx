...
export default function ShowcasePage() {
  ...
  // 风采展示数据 - 12条
  const showcaseData = [
    { title: "【风采展示】国际学院学生在全国大学生英语竞赛中荣获一等奖", date: "2025.08.20" },
    { title: "【风采展示】国际学院优秀毕业生赴俄罗斯远东联邦大学深造", date: "2025.08.18" },
    { title: "【风采展示】国际学院学生创新创业项目获得国家级立项", date: "2025.08.15" },
    { title: "【风采展示】国际学院学生在中俄大学生艺术节中展现才华", date: "2025.08.12" },
    { title: "【风采展示】国际学院学生志愿服务团队获得市级表彰", date: "2025.08.10" },
    { title: "【风采展示】国际学院学生在国际数学建模竞赛中获得佳绩", date: "2025.08.08" },
    { title: "【风采展示】国际学院学生参加中俄青年交流活动", date: "2025.08.05" },
    { title: "【风采展示】国际学院学生在全国大学生计算机设计大赛中获奖", date: "2025.08.03" },
    { title: "【风采展示】国际学院学生社团在校园文化节中精彩亮相", date: "2025.08.01" },
    { title: "【风采展示】国际学院学生在重庆市大学生辩论赛中夺冠", date: "2025.07.28" },
    { title: "【风采展示】国际学院学生参加国际学术会议并发表论文", date: "2025.07.25" },
    { title: "【风采展示】国际学院学生在全国大学生电子设计竞赛中获得优异成绩", date: "2025.07.22" },
  ]

  const totalPages = Math.ceil(showcaseData.length / itemsPerPage)
  const startIndex = (currentPage - 1) * itemsPerPage
  const currentItems = showcaseData.slice(startIndex, startIndex + itemsPerPage)
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>{">"}</span>
            <span className="text-gray-800">风采展示</span>
          </div>
        </div>
      </div>
              ...
              <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-600">
                    展示第{startIndex + 1}-{Math.min(startIndex + itemsPerPage, showcaseData.length)}
                    条信息，共计
                    {showcaseData.length}条信息
                  </div>
