...
export default function DownloadsPage() {
  ...
  const downloadsData = [
    { title: "【下载专区】国际学院学生手册（2025版）", date: "2025.08.20" },
    { title: "【下载专区】中外合作办学项目申请表", date: "2025.08.18" },
    { title: "【下载专区】国际学院课程设置及学分要求", date: "2025.08.15" },
    { title: "【下载专区】学生交流项目申请指南", date: "2025.08.12" },
    { title: "【下载专区】国际学院毕业论文格式要求", date: "2025.08.10" },
    { title: "【下载专区】双学位项目相关文件汇编", date: "2025.08.08" },
    { title: "【下载专区】国际学院奖学金申请表格", date: "2025.08.05" },
    { title: "【下载专区】学生成绩单申请及认证流程", date: "2025.08.03" },
  ]

  const totalPages = Math.ceil(downloadsData.length / itemsPerPage)
  const startIndex = (currentPage - 1) * itemsPerPage
  const currentItems = downloadsData.slice(startIndex, startIndex + itemsPerPage)
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>{">"}</span>
            <span className="text-gray-800">下载专区</span>
          </div>
        </div>
      </div>
              ...
              <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-600">
                    展示第{startIndex + 1}-{Math.min(startIndex + itemsPerPage, downloadsData.length)}条信息，共计
                    {downloadsData.length}条信息
                  </div>
